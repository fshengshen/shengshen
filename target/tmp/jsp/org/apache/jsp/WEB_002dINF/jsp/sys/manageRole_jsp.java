...
public final class manageRole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${shengshen }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/sys/getManageRoleList\"  idField=\"id\" multiSelect=\"true\" >\r\n");
      out.write("        <div property=\"columns\">\r\n");
      out.write("            <div type=\"indexcolumn\"></div>       \r\n");
      out.write("            <div type=\"checkcolumn\"></div>\r\n");
      out.write("            <div field=\"roleId\" width=\"120\" headerAlign=\"center\" allowSort=\"true\">角色Id</div>  \r\n");
      out.write("            <div field=\"roleName\" width=\"120\" headerAlign=\"center\" allowSort=\"true\">角色名称</div>        \r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("    \r\n");
      ...
      out.write("            \r\n");
      out.write("mini.open({\r\n");
      out.write("    url: bootPATH + \"../sys/toAddOrUpdateRole\",\r\n");
      out.write("    title: \"新增角色\", width: 600, height: 400,\r\n");
      ...
      out.write("            var roleName = row.roleName;\r\n");
      out.write("                mini.open({\r\n");
      out.write("                    url: bootPATH + \"../sys/toAddOrUpdateRole?roleId=\" + roleId + \"&roleName=\" + roleName,\r\n");
      out.write("                    title: \"编辑角色\", width: 600, height: 400,\r\n");
      out.write("                    onload: function () {\r\n");
      out.write("                        var iframe = this.getIFrameEl();\r\n");
      ...
      out.write("                        ids.push(r.roleId);\r\n");
      out.write("                    }\r\n");
      out.write("                    var id = ids.join(',');\r\n");
      out.write("                    grid.loading(\"操作中，请稍后......\");\r\n");
      out.write("                    $.ajax({\r\n");
      out.write("                        url: \"../sys/deleteRole?roleId=\" + id,\r\n");
      ...
      out.write("            grid.load({ roleName : key });\r\n");
      out.write("        }\r\n");
      out.write("        function onKeyEnter(e) {\r\n");
      out.write("            search();\r\n");
      out.write("        }\r\n");
      out.write("        /////////////////////////////////////////////////\r\n");
      out.write("//         function onBirthdayRenderer(e) {\r\n");
      out.write("//             var value = e.value;\r\n");
      out.write("//             if (value) return mini.formatDate(value, 'yyyy-MM-dd');\r\n");
      out.write("//             return \"\";\r\n");
      out.write("//         }\r\n");
      out.write("//         function onMarriedRenderer(e) {\r\n");
      out.write("//             if (e.value == 1) return \"是\";\r\n");
      out.write("//             else return \"否\";\r\n");
      out.write("//         }\r\n");
      out.write("//         var Genders = [{ id: 1, text: '男' }, { id: 2, text: '女'}];        \r\n");
      out.write("//         function onGenderRenderer(e) {\r\n");
      out.write("//             for (var i = 0, l = Genders.length; i < l; i++) {\r\n");
      out.write("//                 var g = Genders[i];\r\n");
      out.write("//                 if (g.id == e.value) return g.text;\r\n");
      out.write("//             }\r\n");
      out.write("//             return \"\";\r\n");
      out.write("//         }\r\n");
      out.write("\r\n");
